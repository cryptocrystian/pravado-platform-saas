...
if (!tenantArg) {
  ...
  console.log('Usage: node scripts/deploy-media-database-node.js --tenant=YOUR_TENANT_ID [--mode=quick]');
  process.exit(1);
}
...
const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpzenVqa3BxYnpjbG1oZmZmcmd0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg4MDg4MjUsImV4cCI6MjA2NDM4NDgyNX0.nTfxUB40myBe1Zu1V3lKhLxl_Mif_dB5u_hHtkb5VJY";
...
class MediaDatabaseDeployer {
  ...
  async verifyTenant() {
    ...
    // For demo purposes, we'll skip tenant verification and proceed
    // In production, this would authenticate and verify the user's tenant
